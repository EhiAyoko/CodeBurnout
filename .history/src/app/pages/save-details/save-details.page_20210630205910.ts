...
export class SaveDetailsPage implements OnInit {
  ...
  userid: any;
  currentUser: any;
  constructor(private router: Router,private socialSharing: SocialSharing, private http: HttpClient, private authpostservice: AuthicationService, public afStore: AngularFirestore,) { 
