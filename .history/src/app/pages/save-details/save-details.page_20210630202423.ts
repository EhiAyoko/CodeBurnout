...
export class SaveDetailsPage implements OnInit {
  ...
  currentUser: any;
  uuid: any;
  constructor(private router: Router,private uniqueDeviceID: UniqueDeviceID,private socialSharing: SocialSharing, private http: HttpClient, private authpostservice: AuthicationService, public afStore: AngularFirestore,) { 
