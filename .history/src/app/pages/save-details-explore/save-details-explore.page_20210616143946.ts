...
export class SaveDetailsExplorePage implements OnInit {
  ...
  userid: any;
  currentUser: any;
  constructor(private router: Router, private socialSharing: SocialSharing, private navctrl: NavController, public afStore: AngularFirestore, private http: HttpClient,private authpostservice: AuthicationService) { 
