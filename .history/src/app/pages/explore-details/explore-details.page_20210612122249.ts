...
export class ExploreDetailsPage implements OnInit {
  ...
  constructor(private socialSharing: SocialSharing, private router: Router, private http: HttpClient, private authpostservice: AuthicationService, public afStore: AngularFirestore,) { 
...
sShare(postimg){
  var options = {
    ...
    Name: this.brandsdetails.fields.Name, // fi. for email
    url: postimg.url,
    Notes: this.brandsdetails.fields.Notes, // Android only, you can override the default share sheet title
    TypeOfActivity: this.brandsdetails?.fields?.TypeOfActivity, // Android only, you can provide id of the App you want to share with
