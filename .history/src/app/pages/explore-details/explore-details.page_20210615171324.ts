...
export class ExploreDetailsPage implements OnInit {
  ...
  constructor(private socialSharing: SocialSharing,private navctrl: NavController, private router: Router, private http: HttpClient, private authpostservice: AuthicationService, public afStore: AngularFirestore,) { 
...
backbtn(){
  this.navctrl.navigateForward('saved-activities')
}
}
