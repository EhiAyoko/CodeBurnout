...
export class SavedActivitiesPage implements OnInit {
  ...
  explorerecordsdetails: any[];
    ...
    constructor(public postsService:HttpService,public alertController: AlertController,private navctrl: NavController, public afStore: AngularFirestore, private http: HttpClient, private navCtrl: NavController) {
      this.posts
      this.postsexpolore
      ...
      buttons: [
        {
          ...
          role: 'cancel',
          handler: () => {
            this.navCtrl.navigateForward('team-activities');
          }
        }, {
          text: 'Login',
          handler: () => {
