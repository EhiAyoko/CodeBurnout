...
export class SavedActivitiesPage implements OnInit {
  ...
  uuid: any;
    ...
    constructor(public postsService:HttpService,private uniqueDeviceID: UniqueDeviceID,private navctrl: NavController, public afStore: AngularFirestore, private http: HttpClient, private navCtrl: NavController) {
