 ...
 async ionViewWillEnter() {
    ...
    if(localStorage.getItem('LoginData')){
      ...
      const alert = await this.alertController.create({
        ...
        header: 'Alert',
        // subHeader: 'Subtitle',
        message: 'If you want to use save activity, you need to login',
    ...
    // this.navCtrl.navigateForward('team-details');
  ...
  //   console.log("this.brandsdetails.fields.Video[0].url", this.brandsdetails.fields.Video[0].url)
    ...
    // console.log('video', this.brandsdetails?.fields?.Video[0]?.url)
       ...
       console.log('addrecord', this.userid)
