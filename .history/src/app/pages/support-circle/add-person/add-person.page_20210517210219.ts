...
export class AddPersonPage implements OnInit {
  ...
  constructor(public httpClient: HttpClient,
    public loadingController: LoadingController,private alertController : AlertController,  private navclrl: NavController, public circleService:AirtableDatabaseService,public router: Router,) { 
